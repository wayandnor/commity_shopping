package com.nor.cs.order.controller;
...
public class OrderInfoController {
    ...
    public Result findUserOrderPage(
        ...
        return Result.successWithData(pageModel);
    }
    ...
    public Result queryPayStatus(
        ...
        for (int i = 0; i <=3; i++) {
            if(i==3) {
                return Result.successWithData(ResultCodeEnum.SUCCESS);
            }
        }
        return Result.successWithData(ResultCodeEnum.URL_ENCODE_ERROR);
    }
    ...
    public Result confirm() {
        ...
        return Result.successWithData(orderConfirmVo);
    }
    ...
    public Result submitOrder(@RequestBody OrderSubmitVo orderParamVo) {
        ...
        return Result.successWithData(orderId);
    }
